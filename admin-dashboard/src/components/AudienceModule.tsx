...
const AudienceModule = () => {
  const [activeSubTab, setActiveSubTab] = useState<'contacts' | 'contact-lists' | 'audience-lists'>('contacts');
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm">Manage contacts, contact lists, and combined audience targeting lists.</p>
      </div>
